<script runes>
	...
	class FitnessTrackerStore{
		...
		get stepsTaken(){ return this._stepsTaken }
	...
	function createFitnessTrackerStore(){
		...
		return {
			...
			get caloriesBurned() { return caloriesBurned },
			get intensityLevel() { return intensityLevel },
			set intensityLevel(v) { intensityLevel = v },
		}
	}
...
<table>
	<tbody>
		...
		<tr>
			...
			<td><input type="range" bind:value={fitTracker.intensityLevel} min="0.5" max="1.5" step="0.1" on:click|stopPropagation></td>
		</tr>
		<tr>
			<td>Calories</td>
...
<table>
	<tbody>
		...
		<tr>
			...
			<td><input type="range" bind:value={fitTracker2.intensityLevel} min="0.5" max="1.5" step="0.1" on:click|stopPropagation></td>
		</tr>
		<tr>
			<td>Calories</td>
